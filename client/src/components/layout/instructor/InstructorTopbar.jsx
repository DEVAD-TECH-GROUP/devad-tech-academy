  ...
  return (
    <header className="h-14 bg-surface border-b border-border flex items-center px-4 gap-3 shrink-0">
      ...
      <button
        ...
        className="hidden sm:flex items-center gap-2 bg-orange/10 border border-orange/20 text-orange text-xs font-medium px-3 py-1.5 rounded-xl hover:bg-orange/20 transition"
      >
        <span>+</span> New Course
      </button>

      <button onClick={() => navigate("/instructor/notifications")} className="relative p-2 text-muted hover:text-text transition">
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
